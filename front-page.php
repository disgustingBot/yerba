...
<figure class="ATFIsoLogo">
  ...
  <figure class="cardsATF cardATF1">
    <img class="cardsATFImg" src="<?php echo get_template_directory_uri(); ?>/img/home/localizaciones.jpg" alt="">
  ...
  <figure class="cardsATF cardATF2">
    <img class="cardsATFImg" src="<?php echo get_template_directory_uri(); ?>/img/home/gastronomia.jpg" alt="">
    <figcaption class="cardsATFTxt specialTitle">
        <h3>Gastronomía</h3>
    </figcaption>
  </figure>
  ...
  <figure class="cardsATF cardATF3">
    <img class="cardsATFImg" src="<?php echo get_template_directory_uri(); ?>/img/home/experiencias.jpg" alt="">
    <figcaption class="cardsATFTxt specialTitle">
      <h3>Experiencias</h3>
    </figcaption>
  </figure>
