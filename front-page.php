...
<section class="homeATF">
  ...
  <flex class="homeATFflex flex3">
    ...
    <figure class="card">
      <img class="standarCardImg" src="<?php echo get_template_directory_uri(); ?>/img/home/OCNVW50.jpg" alt="">
    ...
    <figure class="card">
      <img class="standarCardImg" src="<?php echo get_template_directory_uri(); ?>/img/home/952.jpg" alt="">
      <figcaption class="cardTitle specialTitle">
          <h3>Gastronomía</h3>
      </figcaption>
    </figure>
    ...
    <figure class="card">
      <img class="standarCardImg" src="<?php echo get_template_directory_uri(); ?>/img/home/1485.jpg" alt="">
      <figcaption class="cardTitle specialTitle">
        <h3>Experiencias</h3>
      </figcaption>
    </figure>
...
<section class="section">
    ...
    <figure class="standarCard rowcol1">
      <img class="standarCardImg rowcol1" src="<?php echo get_template_directory_uri(); ?>/img/home/OCNVW50.jpg" alt="">
      <figcaption class="">
...
<section class="section alt">
  ...
  <figure class="standarCard rowcol1">
    <img class="standarCardImg rowcol1" src="<?php echo get_template_directory_uri(); ?>/img/home/952.jpg" alt="">
    <figcaption class="">
      <h5>En nuestros ambientes y restaurantes respirarás y sentirás que hasta el más mínimo detalle está por y para ti.</h5>
      <p>¿Eres mas de mar o de montaña?  Descubre lugares magicos en los que disfrutar de lo mejor de la vida.</p>
    </figcaption>
  ...
  <flex class="flex3 colMax">
    ...
    <figure class="hidshow grid">
      <img src="<?php echo get_template_directory_uri(); ?>/img/home/80.jpg" alt="" class="hidshowImg rowcol1">
      <figcaption class="grid rowcol1">
        <p class="itemTitle rowcol1 itemTitleTR">Soy el nene</p>
        <p class="rowcol1 hidshowTxt">
          Et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga
    ...
    <figure class="hidshow grid">
      <img src="<?php echo get_template_directory_uri(); ?>/img/home/7781.jpg" alt="" class="hidshowImg rowcol1">
      <figcaption class="grid rowcol1">
        <p class="itemTitle rowcol1 itemTitleTR">Soy el nene</p>
        <p class="rowcol1 hidshowTxt">
          Et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga
    ...
    <figure class="hidshow grid">
      <img src="<?php echo get_template_directory_uri(); ?>/img/home/954.jpg" alt="" class="hidshowImg rowcol1">
      <figcaption class="grid rowcol1">
    ...
    <figure class="hidshow grid">
      <img src="<?php echo get_template_directory_uri(); ?>/img/home/1301764.jpg" alt="" class="hidshowImg rowcol1">
      <figcaption class="grid rowcol1">
        <p class="itemTitle rowcol1 itemTitleBR">Soy el nene</p>
        <p class="rowcol1 hidshowTxt">
          Et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga
...
<section class="section experiencias">
  ...
  <figure class="standarCard rowcol1">
    <img class="standarCardImg rowcol1" src="<?php echo get_template_directory_uri(); ?>/img/home/surfer-ocean_1321-1255.jpg" alt="">
    <figcaption class="">
      <h5>En nuestros ambientes y restaurantes respirarás y sentirás que hasta el más mínimo detalle está por y para ti.</h5>
      <p>¿Eres mas de mar o de montaña?  Descubre lugares magicos en los que disfrutar de lo mejor de la vida.</p>
    </figcaption>
