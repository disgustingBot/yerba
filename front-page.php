...
<section class="ATF">
  ...
  <figure class="ATFIsoLogo">
    <img class="ATFLogo itemImg" src="<?php echo get_template_directory_uri(); ?>/img/logoCalaBassa.png" alt="">
...
<section class="fPSection localizaciones">
  ...
  <article class="localizacionesHead fPSectionHead">
    ...
    <figure class="localizacionesHeadFigure1 fPSectionFigure">
      <img src="<?php echo get_template_directory_uri(); ?>/img/home/localizaciones.jpg" alt="" class="localizacionesHeadImg fPSectionImg itemImg">
...
<section class="fPSection gastronomia">
  ...
  <article class="gastronomiaHead fPSectionHead">
    ...
    <figure class="gastronomiaHeadFigure2 fPSectionFigure">
      <img src="<?php echo get_template_directory_uri(); ?>/img/home/gastronomia.jpg" alt="" class="gastronomiaHeadImg fPSectionImg itemImg">
  ...
  <div class="gastronomiaContainer">
    <figure class="gastronomiaItem33 SectionItem">
      ...
      <img src="<?php echo get_template_directory_uri(); ?>/img/home/9948.jpg" alt="" class="gastronomiaItemImg itemImg">
    ...
    <figure class="gastronomiaItem33 SectionItem">
      ...
      <img src="<?php echo get_template_directory_uri(); ?>/img/home/7781.jpg" alt="" class="gastronomiaItemImg itemImg">
    ...
    <figure class="gastronomiaItem50 SectionItem">
      ...
      <img src="<?php echo get_template_directory_uri(); ?>/img/home/954.jpg" alt="" class="gastronomiaItemImg itemImg">
    ...
    <figure class="gastronomiaItem50  SectionItem">
      ...
      <img src="<?php echo get_template_directory_uri(); ?>/img/home/1301764.jpg" alt="" class="gastronomiaItemImg itemImg">
