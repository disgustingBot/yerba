...
<footer class="footer">
  ...
  <div class="socialContainer">
    ...
    <a class="socialItem pinterestFooter" href="https://www.instagram.com/calabassabeachclub/" target="_blank">
      <svg class="googleFooter pinterestFooter" fill="currentColor" version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      width="38.062px" height="38.061px" viewBox="0 0 38.062 38.061" enable-background="new 0 0 38.062 38.061" xml:space="preserve">
        <g id="XMLID_1678_">
          ...
          <path id="XMLID_1679_" fill="#000000" d="M12.94,20.798c0.297,0.122,0.563,0.006,0.65-0.324c0.059-0.228,0.201-0.803,0.265-1.042
